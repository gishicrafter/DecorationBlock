...
public class GuiIconButton extends GuiButton
{
	...
	public GuiIconButton(int par1, int par2, int par3, String par4Str, ButtonIconProvider provider)
	{
		this(par1, par2, par3, 16, 16, par4Str, provider);
	}

	public GuiIconButton(int par1, int par2, int par3, int par4, int par5, String par6Str, ButtonIconProvider provider)
	{
